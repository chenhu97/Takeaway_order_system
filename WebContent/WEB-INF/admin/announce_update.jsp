			...
			<div class="wrapper">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="active"><a style="cursor: pointer">公告修改</a></li>
					</ul>
				...
				<!-- /page header -->
				<form action="Announce?oper=updateDeal" method="post" id="tab" enctype="multipart/form-data">
						<input type="hidden" id="announceId" name="announceId" value="${announceId}" >
					<div>
						<label>标题</label> <input type="text" class="input-xlarge"
							name="title" value="${bean.title}">
					</div>
					<div>
						<label>公告配图</label> <img src="${AppRootPath}${bean.picPath}" />
					</div>
					<div>
						<label>选择图片</label> <input type="file" name="picPath"
							value="${picPath}">
					</div>
