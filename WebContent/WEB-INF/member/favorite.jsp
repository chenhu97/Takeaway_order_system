				...
				<div class="container">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="StoreMain?oper=order">我的收藏</a></li>
						...
						<div class="col-sm-9">
							<div id="owl-product-1" class="owl-carousel">
								<div class="item" style="margin-left: 150px;">
									<div class="item_miao">
										<a name="miao1">收藏列表<span class="leimu_remark"></span></a>
									</div>
									<table id="tab">
										<tr>
											<td>收藏编号</td>
										...
										<c:forEach var="item" items="${favoriteList}"
											...
											<tr>
												...
												<td id="tda">
													<p>
														<a href='StoreMain?oper=list&storeId=${item.storeId}'>进入店铺</a>
													</p> 
													<p>
														<a href='Favorite?oper=deletedeal2&storeId=${item.storeId}' id="quxiao">取消收藏</a>
													</p> 
												</td>
											</tr>
										</c:forEach>
