...
<body class="sub-page">
			...
			<section class="box-content box-2 box-style-2">
				<div class="container-fluid">
					<div class="collapse navbar-collapse navbar-ex1-collapse"
						id="nav_tab">
						<ul id="tab">
							<li><a href="StoreMain?oper=list"> &nbsp; &nbsp;所有商品
									&nbsp; &nbsp; </a>|</li>
							<li><a href="StoreMain?oper=message&storeId=${storeId}"> &nbsp; &nbsp;评价 &nbsp; &nbsp; </a>|</li>
							<li><a href="contact.html"> &nbsp; &nbsp;商家资质 &nbsp;
									&nbsp; </a></li>
						</ul>
						<div id="nav_search">
						...
						<div class="list_btn">
							...
							<button class="btn all_list" onclick="javascript:location.href='StoreMain?oper=alllist&storeId=${id}';"><span class="glyphicon glyphicon-list"></span></button>
							<button class="btn option_list" onclick="javascript:location.href='StoreMain?oper=optionlist&storeId=${id}';"><span class="glyphicon glyphicon-indent-left"></span><span class="glyphicon glyphicon-indent-right"></span></button>
						</div>
					</div>
						...
						<div class="col-sm-9">
							<div class="row heading">
								...
								<div class="col-lg-11" id="leimu">
									<a style="margin-left: -600px">所有分类：</a>
	...
	<div class="car_header">
		购物车<a href="#" class="car_qingkong">[清空]</a><span class="glyphicon glyphicon-shopping-cart car_header_icon"></span>
	</div>
	<div class="car_contennt">
