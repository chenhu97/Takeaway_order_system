						...
						<div class="module">
							...
							<div class="module-body">
								...
								<form class="form-horizontal  row-fluid" action="FoodCat"
									...
									<input type="hidden" name="oper" value="insertDeal" /> <label
								...
								<button class="btn btn-success" onclick="javascript:location.href='FoodCat?oper=list';">返回列表</button>
							</div>
						</div>
