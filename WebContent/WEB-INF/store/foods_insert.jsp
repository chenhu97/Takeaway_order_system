				...
				<div class="span9">
					<div class="content">
						<h5 class="widget-name">
							<i class="icon-ok"></i>添加菜品
						</h5>

						<form id="validate" class="form-horizontal" action="Foods?oper=insertdeal"

							method="post" enctype="multipart/form-data">
							<input type="hidden" class="btn" name="oper" value="insertdeal" />
