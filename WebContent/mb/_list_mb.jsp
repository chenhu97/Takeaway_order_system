						...
						<button class="btn" type="button">
							<i class="icon-search"></i>
								...
								<table class="table table-striped table-bordered"
									...
									<thead>
										<tr>
											<th><input type="checkbox" name="checkall" id="checkall" class="checkall" value=""></input></th>
											<th>菜品类目id</th>
											<th>类目名称</th>
											<th>店铺名称</th>
											<th>操作</th>
									...
									<tbody>
										<tr>
											<td><input type="checkbox" name="checkbox"  value="${bean.catId}"></input></td>
											<td>Mark</td>
											<td>Otto</td>
											<td>@mdo</td>
											<td>
											<a class="btn btn-success" href="Member?oper=update&id=${bean.userId}"><i ></i>&nbsp;&nbsp;编辑</a>
								<a class="btn btn-danger" href="javascript:"onclick="item_del(this, ${bean.userId})"> <i class="ico-trash"> </i>&nbsp;&nbsp;删除</a>
								<a class="btn btn-info" href="Member?oper=detail&id=${bean.userId}"><i class="ico-eye-open"></i>&nbsp;&nbsp;查看</a></td>
